## Use framebuffers to create a rear-view mirror
![image](https://user-images.githubusercontent.com/98029669/213900343-98dab982-78e3-4e7e-9b8c-8da4283372c6.png)  
```C++
...
int main()
{
    ...
    // build and compile shaders, remember two different shaders
    // -------------------------
